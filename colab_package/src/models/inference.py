...
from src.asl.schema import ASLPrediction, build_gloss_items
...
def predict_gloss(
    ...
    Args:
        ...
        normalization_result: Optional precomputed normalization payload.
    """
    normalized = normalization_result or normalize_text(text)
    ...
    return ASLPrediction(
        ...
        gloss_items=build_gloss_items(gloss_tokens),
